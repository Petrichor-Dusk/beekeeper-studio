...
class BeekeeperWindow {
  ...
  constructor(
    protected settings: IGroupedUserSettings,
    ...
    let titleBarStyle: "default" | "hidden" = platformInfo.isWindows
      ? "default"
      : "hidden";
  ...
  private async initialize() {
    ...
    if (
      ...
      // DevTools is NOT opened automatically on startup. Toggle it manually
      // with F12 / Ctrl+Shift+I when needed.
      globalShortcut.register(
        "F12",
        this.win.webContents.toggleDevTools.bind(this.win.webContents)
      );
      globalShortcut.register(
  ...
  private getWindowPosition(settings: IGroupedUserSettings) {
    ...
    const isRectangle = (obj: any): obj is Rectangle =>
      typeof obj === "object" &&
      typeof obj.x === "number" &&
      typeof obj.y === "number" &&
  ...
  initializeCallbacks() {
    ...
    const windowMoveResizeListener = _.debounce(
      this.windowMoveResizeListener.bind(this),
      1000
    );
